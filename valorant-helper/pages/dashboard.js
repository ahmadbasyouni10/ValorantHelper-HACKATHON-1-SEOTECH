    ...
    return (
        ...
        >
            ...
            >
                ...
                <Heading letterSpacing="tight" size="md" my={4}></Heading>
                <Flex>
                ...
                <Text color="gray" mt={10} mb={2}></Text>
                <InputGroup>
                    <InputLeftElement
                        pointerEvents="none"
                ...
                <Text color="gray" mt={4} mb={2}></Text>
                <InputGroup>
                    <InputLeftElement
                        pointerEvents="none"
                ...
                <Button mt={4} bgColor="blackAlpha.900" color="#fff" p={7} borderRadius={15}>CHAT</Button>
            </Flex>
        </Flex>
    )
}